...
router.delete('/delete/:id', authMiddleware, roleMiddleware(['doctor', 'admin']), handleDoctorDelete);
...
router.delete('/delete/:id', authMiddleware, roleMiddleware(['doctor']), async (req, res) => {
    const { id } = req.params;
